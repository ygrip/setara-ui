...
<svelte:head>
  <title>Coverage Map - {data.projectKey} - Setara</title>
</svelte:head>
...
<div class="page">
  <nav class="breadcrumb">
    ...
    <span>/</span>
    <a href="/projects/{data.projectKey}/repository">Repository</a>
    <span>/</span>
  ...
  <div class="page-header">
    <div>
      <p>Test Repository</p>
      <h1>Coverage Map</h1>
      <span>Directory coverage, automation gaps, and risky scenarios.</span>
    </div>
  ...
  {:else if data.coverageMap}
    <SetaraMindMap map={data.coverageMap} />
  {/if}
</div>
